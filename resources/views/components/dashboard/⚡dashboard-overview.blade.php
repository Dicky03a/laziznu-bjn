        ...
        <div class="px-4 sm:px-6 lg:px-8 py-6 mx-auto">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex gap-3 flex-wrap">
                    <a href="{{ route('laporan.export-excel') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-all duration-200 font-medium text-sm shadow-sm hover:shadow-md">

            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                  ...
                  <div class="lg:col-span-2 space-y-8">
                        ...
                        <div id="form-donasi" class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 scroll-mt-8">
                              ...
                              <form action="{{ route($program->type . '.store', $program->slug) }}" method="POST" data-payment-form="donasi" x-data="locationSelector()">
                                    @csrf
                  ...
                  async loadDesa() {
                        ...
                        try {
                              ...
                              if (response.ok) {
                                    ...
                                    // Only reset if we're not initializing with an old value

    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
        <div class="max-w-3xl">
            <nav class="flex items-center gap-2 text-sm text-gray-300 mb-6">
                ...
                <a href="{{ route('program-zakat.index') }}" class="hover:text-white transition-colors">Program Zakat</a>
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                </svg>
            ...
            <div class="flex items-center gap-3 text-gray-300">
                ...
                <span>Terpadu Muzakki &middot; Kabupaten Bojonegoro</span>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div class="text-center p-6 bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl">
                                <p class="text-sm text-emerald-700 font-medium mb-2">Zakat Terkumpul</p>
                            ...
                            <div class="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl">
                                <p class="text-sm text-blue-700 font-medium mb-2">Total Muzakky</p>
                                <h2 class="text-3xl font-bold text-blue-600">{{ number_format($totalDonatur) }}</h2>
                            </div>
                        </div>

                        <p class="text-sm text-gray-600 text-center italic">"Ambillah zakat dari sebagian harta mereka, dengan zakat itu kamu membersihkan dan mensucikan mereka" (QS. At-Taubah: 103)</p>

                        <a href="#form-donasi"
                            class="group bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 text-white py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3">
                ...
                <div id="form-donasi" class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 scroll-mt-8"
                    x-data="zakatForm()">
                    <h2 class="text-xl font-bold text-gray-900 mb-6">Formulir Zakat</h2>
                    ...
                    <form action="{{ route('program-zakat.store', $program->slug) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-3 sm:grid-cols-4 gap-2 mb-3">
                                @foreach([100000, 200000, 500000, 1000000] as $nominal)
                                <button type="button"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Nama Muzakky <span class="text-red-500">*</span></label>
                                <input type="text" name="nama_donatur" id="nama_program"
                                    value="{{ old('nama_donatur') }}" placeholder="Nama Lengkap Anda"
                            ...
                            <div>
                                ...
                                <select name="desa_id"
                                    ...
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 bg-white text-gray-900 disabled:bg-gray-100 disabled:text-gray-400 @error('desa_id') border-red-500 @enderror"
                                    required>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="catatan" rows="2"
                                    placeholder="Semoga zakat ini membawa berkah..."
                        ...
                        <button type="submit"
                            ...
                            class="mt-6 w-full py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3 disabled:opacity-50">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h2 class="text-xl font-bold text-gray-900 mb-5">Muzakky Terbaru</h2>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                            <div class="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700 font-bold text-sm flex-shrink-0">
                                {{ strtoupper(substr($trx->nama_donatur, 0, 1)) }}
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 text-sm truncate">{{ $trx->is_anonim ? 'Hamba Allah' : $trx->nama_donatur }}</p>
                                <p class="text-xs text-gray-500">{{ $trx->created_at->diffForHumans() }}</p>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-emerald-600 text-sm">Rp {{ number_format($trx->jumlah, 0, ',', '.') }}</p>
                                @if($trx->catatan)
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-3xl p-6 border border-emerald-200">
                        ...
                        <div class="space-y-3 text-sm text-gray-700">
                            <p class="flex items-start gap-2">
                                ...
                                <span>Dana disalurkan sesuai syariat Islam</span>
                            </p>
                            <p class="flex items-start gap-2">
                                <span class="text-emerald-600 font-bold">•</span>
                                <span>Laporan transparansi dapat diakses publik</span>
                            </p>
                            <p class="flex items-start gap-2">
                                <span class="text-emerald-600 font-bold">•</span>
                                <span>Tercatat otomatis di Peta Sebaran Muzakky</span>
                            </p>
                        </div>
                    </div>
                </div>

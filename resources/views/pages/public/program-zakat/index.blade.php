...
@section('title', 'Program Zakat - Lazisnu Bojonegoro')
@section('content')
...
<section class="relative bg-gradient-to-br from-emerald-600 to-emerald-700 py-20 sm:py-24 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <div class="inline-block mb-6 px-4 py-1.5 bg-emerald-500/20 backdrop-blur-sm rounded-full border border-emerald-400/30">
            <span class="text-emerald-200 text-sm font-medium">Program Zakat Lazisnu Bojonegoro</span>
        </div>
        ...
        <p class="text-base sm:text-lg text-emerald-100/90 max-w-2xl mx-auto leading-relaxed">
            Salurkan zakat Anda untuk program-program pemberdayaan umat yang spesifik dan tepat sasaran
        </p>
    </div>
    <div class="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 mt-10">
        <a href="{{ route('zakat.index') }}" class="inline-block px-6 py-3 bg-emerald-500 text-white font-medium rounded-full hover:bg-emerald-600 transition-colors">
            Zakat Fitrah & Mal
        </a>
    </div>
</section>
...
<section class="bg-gray-50 py-16 sm:py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center py-20">
            ...
            <p class="text-gray-500 font-semibold text-lg">Belum ada program zakat tersedia</p>
            <p class="text-gray-400 text-sm mt-1">Silakan cek kembali nanti</p>
        </div>
        @else
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            @foreach($programs as $program)
            <a href="{{ route('program-zakat.show', $program->slug) }}"
                ...
                <div class="p-6 flex flex-col flex-1">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="px-2.5 py-0.5 bg-emerald-100 text-emerald-700 text-xs font-semibold rounded-full">Zakat</span>
                        <span class="px-2.5 py-0.5 bg-gray-100 text-gray-600 text-xs font-medium rounded-full">Terpadu Muzakki</span>
                    </div>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-100">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs text-gray-400 mt-0.5">muzakky</p>
                            </div>
                        </div>
                    </div>

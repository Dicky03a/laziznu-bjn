      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
            <div class="max-w-3xl">
                  ...
                  <div class="flex gap-6 mt-8">
                        <div>
                              <p class="text-2xl font-bold text-emerald-400">{{ number_format($totalMuzakki) }}</p>
                              <p class="text-xs text-gray-400 mt-0.5">Total Muzakki</p>
                        </div>
                  ...
                  <div class="lg:col-span-1">
                        <div class="sticky top-8 space-y-6">
                              ...
                              <div class="bg-white rounded-3xl p-5 border border-gray-100">
                                    ...
                                    <a href="https://wa.me/6285640019811" target="_blank"

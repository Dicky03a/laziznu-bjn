...
@section('title', 'Status MWC & Ranting - Lazisnu Bojonegoro')
@section('content')
...
<section class="bg-gradient-to-br from-emerald-700 via-emerald-600 to-emerald-800 py-24 text-white">
      <div class="max-w-5xl mx-auto px-6 text-center">
            ...
            <p class="text-emerald-50 max-w-2xl mx-auto leading-relaxed text-lg">
                  Transparansi penuh dalam status MWC dan Ranting Lazisnu Bojonegoro. Akses dan lihat laporan lengkap kami di bawah ini.
            </p>
      </div>
</section>
                  ...
                  <div class="border border-gray-200 rounded-2xl overflow-hidden shadow-sm bg-white transition-all duration-300">
                        ...
                        >
                              <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                          <h3 class="text-xl font-semibold text-gray-800">{{ $laporan->nama }}</h3>
                              ...
                              <div class="p-4 bg-gray-50 border-t border-gray-100">
                                    <div class="w-full rounded-xl overflow-hidden shadow-inner border border-gray-200 bg-white">
                                          <template x-if="activeAccordion === {{ $laporan->id }}">
                                                <iframe
                                                      src="{{ asset('pdfjs/web/viewer.html') }}?file={{ asset('storage/laporan-mwc/' . $laporan->file_laporan) }}"
                                                      class="w-full h-[80vh]"
                                                      loading="lazy">
                                                </iframe>
                                          </template>
      ...
      @else
            <div class="text-center py-24">
                  ...
                  <p class="text-gray-500 max-w-sm mx-auto">
                        Laporan MWC dan Ranting belum tersedia saat ini. Silahkan cek kembali di lain waktu.
                  </p>
            </div>
      @endif
</div>

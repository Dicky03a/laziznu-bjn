...
<div class="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
      <!-- Hero Section -->
      <div class="relative py-12 md:py-20 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div class="text-center">
                        <h1 class="text-4xl md:text-5xl font-bold text-emerald-600 dark:text-emerald-400 mb-3">
                              Laporan Tahunan
                        </h1>
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-4">
            ...
            <div class="text-center py-16">
                  <svg class="w-20 h-20 text-slate-300 dark:text-slate-600 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Panduan Section -->
<div class="bg-slate-100 dark:bg-slate-700/50 border-t border-slate-200 dark:border-slate-700 py-12 md:py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

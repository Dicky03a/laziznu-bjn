<x-layouts::app :title="__('Tambah Laporan Mwc')">
      ...
      <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                  <h1 class="text-2xl font-bold text-gray-900">Tambah Laporan MWC</h1>
                  <p class="text-sm text-gray-500 mt-0.5">Unggah laporan MWC baru dalam format PDF</p>
            </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <form method="POST" action="{{ route('laporan-mwc.store') }}"

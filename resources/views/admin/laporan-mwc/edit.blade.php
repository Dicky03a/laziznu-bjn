      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <form method="POST" action="{{ route('laporan-mwc.update', $laporanMwc->id) }}"
                              ...
                              <div class="flex items-start gap-3 p-3.5 bg-blue-50 border border-blue-200 rounded-xl text-sm">
                                    ...
                                    <div>
                                          ...
                                          <p class="text-blue-700 text-xs mt-0.5">{{ $laporanMwc->file_laporan }}</p>
                              ...
                              <div class="flex flex-col sm:flex-row gap-3 pt-2 border-t border-gray-100">
                                    ...
                                    <a href="{{ route('laporan-mwc.index') }}"
                  ...
                  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-5 space-y-3 text-sm">
                              <div class="flex justify-between py-2 border-b border-gray-50">
                                    ...
                                    <span class="font-semibold text-gray-800">#{{ $laporanMwc->id }}</span>
                              </div>
                              <div class="flex justify-between py-2 border-b border-gray-50">
                                    <span class="text-gray-500">Dibuat</span>
                                    <div class="text-right">
                                          <p class="font-semibold text-gray-800">{{ $laporanMwc->created_at->format('d M Y') }}</p>
                                          <p class="text-xs text-gray-400">{{ $laporanMwc->created_at->format('H:i') }}</p>
                                    </div>
                              </div>
                              <div class="flex justify-between py-2 border-b border-gray-50">
                                    <span class="text-gray-500">Diperbarui</span>
                                    <div class="text-right">
                                          <p class="font-semibold text-gray-800">{{ $laporanMwc->updated_at->format('d M Y') }}</p>
                                          <p class="text-xs text-gray-400">{{ $laporanMwc->updated_at->format('H:i') }}</p>
                                    </div>
                              </div>

<x-layouts::app :title="__('Laporan MWC')">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                  ...
                  <p class="text-sm text-gray-500 mt-1">Kelola dan pantau semua laporan MWC</p>
            </div>
            <a href="{{ route('laporan-mwc.create') }}"
      ...
      <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
                  ...
                  <h2 class="font-semibold text-gray-900 text-sm">Daftar Laporan MWC</h2>
                  <span class="ml-auto text-xs text-gray-400">{{ $laporanMwc->total() }} laporan</span>
            </div>
                              ...
                              <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-5 py-3.5">
                                          <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-100 text-gray-600 font-semibold text-xs">
                                                {{ ($laporanMwc->currentPage() - 1) * $laporanMwc->perPage() + $loop->iteration }}
                                          </span>
                                    </td>
                                    <td class="px-5 py-3.5">
                                          <p class="font-semibold text-gray-900">{{ $laporan->nama}}</p>
                                    </td>
                                    ...
                                    <td class="px-5 py-3.5">
                                          <div class="flex items-center justify-center gap-1">
                                                <a href="{{ route('laporan-mwc.show', $laporan->id) }}"
                                                      title="Lihat Detail"
                                                ...
                                                <a href="{{ route('laporan-mwc.edit', $laporan->id) }}"
                                                      title="Edit"
                                                ...
                                                <form method="POST" action="{{ route('laporan-mwc.destroy', $laporan->id) }}" class="inline"
      ...
      <div class="bg-white rounded-xl border border-gray-200 py-20 text-center">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-1">Belum Ada Laporan MWC</h3>
            <p class="text-sm text-gray-500 mb-6 max-w-sm mx-auto">
                  Mulai buat laporan MWC pertama untuk mengelola data dengan lebih terorganisir.
            </p>
            <a href="{{ route('laporan-mwc.create') }}"

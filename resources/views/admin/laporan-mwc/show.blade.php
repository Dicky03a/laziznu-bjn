<x-layouts::app :title="$laporanMwc->nama">
            ...
            <div class="lg:col-span-2">
                  ...
                  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
                              ...
                              <span class="ml-auto text-xs text-gray-400 font-mono">{{ $laporanMwc->file_laporan }}</span>
                        </div>
                  ...
                  <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-5 space-y-3 text-sm">
                              ...
                              <div class="border-t border-gray-100 pt-3">
                                    ...
                                    <p class="font-semibold text-gray-900">{{ $laporanMwc->created_at->format('d F Y') }}</p>
                              ...
                              <div class="border-t border-gray-100 pt-3">
                                    ...
                                    <p class="font-semibold text-gray-900">{{ $laporanMwc->updated_at->format('d F Y') }}</p>
                              ...
                              <div class="border-t border-gray-100 pt-3 flex justify-between items-center">
                                    ...
                                    <span class="text-xs font-semibold text-gray-700">{{ $laporanMwc->created_at->diffInDays() }} hari</span>
                              </div>
                        </div>
                  </div>

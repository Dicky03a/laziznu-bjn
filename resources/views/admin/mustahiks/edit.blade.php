<x-layouts::app :title="__('Edit Mustahik')">
            ...
            <div class="max-w-2xl mx-auto space-y-6">
                  ...
                  <div>
                        ...
                        <p class="text-slate-600  mt-2">
                              Perbarui informasi mustahik
                        </p>
                  </div>

                  <!-- Form Card -->
                  <div class="bg-white  rounded-2xl shadow-xl border border-slate-200  p-6 md:p-8">
                        <form action="{{ route('mustahiks.update', $mustahik) }}" method="POST" x-data="Mustahik()"
                              ...
                              <div>
                                    ...
                                    <input type="text" id="nama" name="nama" value="{{ old('nama', $mustahik->nama) }}"
                                          placeholder="Nama lengkap mustahik"
                                          class="w-full px-4 py-2.5 bg-slate-50  border @error('nama') border-red-500 @else border-slate-300  @enderror rounded-lg text-slate-900  placeholder-slate-500  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          required>
                                    @error('nama')
                              ...
                              <!-- NIK -->
                              <div>
                                    <label for="nik" class="block text-sm font-semibold text-slate-900  mb-2">
                                          NIK <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" id="nik" name="nik" value="{{ old('nik', $mustahik->nik) }}"
                                          placeholder="16 digit nomor identitas"
                                          class="w-full px-4 py-2.5 bg-slate-50  border @error('nik') border-red-500 @else border-slate-300  @enderror rounded-lg text-slate-900  placeholder-slate-500  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          maxlength="16"
                                          inputmode="numeric"
                                          required>
                                    @error('nik')
                              ...
                              <!-- Jenis Kelamin -->
                              <div>
                                    <label for="jenis_kelamin" class="block text-sm font-semibold text-slate-900  mb-2">
                                          Jenis Kelamin <span class="text-red-500">*</span>
                                    </label>
                                    <select id="jenis_kelamin" name="jenis_kelamin"
                                          class="w-full px-4 py-2.5 bg-slate-50  border @error('jenis_kelamin') border-red-500 @else border-slate-300  @enderror rounded-lg text-slate-900  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          required>
                                          <option value="">-- Pilih Jenis Kelamin --</option>
                                          <option value="laki-laki" {{ old('jenis_kelamin', $mustahik->jenis_kelamin) == 'laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                          <option value="perempuan" {{ old('jenis_kelamin', $mustahik->jenis_kelamin) == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                    @error('jenis_kelamin')
                                    <p class="text-red-600  text-sm mt-1">{{ $message }}</p>
                                    @enderror
                              ...
                              <div>
                                    ...
                                    <select
                                          ...
                                          x-model="kecamatanId"
                                          @change="loadDesa()"
                                          class="w-full px-4 py-2.5 bg-slate-50  border 
                                          @error('kecamatan_id') border-red-500 
                                          @else border-slate-300  
                                          @enderror rounded-lg text-slate-900  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          required>
                                          <option value="">-- Pilih Kecamatan --</option>
                                          @foreach($kecamatans as $kecamatan)
                                          <option
                                                value="{{ $kecamatan->id }}"
                                                {{ old('kecamatan_id', $mustahik->kecamatan_id) == $kecamatan->id ? 'selected' : '' }}>
                                                {{ $kecamatan->nama }}
                                          </option>
                                          @endforeach
                                    </select>
                              ...
                              <div>
                                    ...
                                    <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp', $mustahik->no_hp) }}"
                              ...
                              <!-- Kategori Asnaf -->
                              <div>
                                    <label for="kategori_asnaf" class="block text-sm font-semibold text-slate-900  mb-2">
                                          Kategori Asnaf <span class="text-red-500">*</span>
                                    </label>
                                    <select id="kategori_asnaf" name="kategori_asnaf"
                                          class="w-full px-4 py-2.5 bg-slate-50  border @error('kategori_asnaf') border-red-500 @else border-slate-300  @enderror rounded-lg text-slate-900  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          required>
                              ...
                              <div>
                                    ...
                                    <select id="status" name="status"
                                          class="w-full px-4 py-2.5 bg-slate-50  border @error('status') border-red-500 @else border-slate-300  @enderror rounded-lg text-slate-900  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                          required>
      ...
      <script>
            function Mustahik() {
                  return {
                        ...
                        kecamatanId: '{{ old("kecamatan_id", $mustahik->kecamatan_id) }}',
                        desaId: '{{ old("desa_id", $mustahik->desa_id) }}',
                        desas: [],

                              ...
                              <table class="w-full">
                                    <thead class="bg-slate-50  border-b border-slate-200 ">
                                          <tr>
                                                ...
                                                <th class="px-6 py-3 text-left text-sm font-semibold text-slate-900 ">{{ __('NIK') }}</th>
                                                <th class="px-6 py-3 text-left text-sm font-semibold text-slate-900 ">{{ __('No HP') }}</th>
                                                <th class="px-6 py-3 text-left text-sm font-semibold text-slate-900 ">{{ __('Desa') }}</th>
                                    ...
                                    <tbody class="divide-y divide-slate-200 ">
                                          ...
                                          <tr class="hover:bg-slate-50  transition-colors">
                                                ...
                                                <td class="px-6 py-4">
                                                      <p class="font-mono text-sm text-slate-600 ">{{ $item->nik }}</p>
                                                </td>
                                                <td class="px-6 py-4">
                                                      <p class="text-slate-600 ">{{ $item->no_hp }}</p>
                                                </td>
                                                <td class="px-6 py-4">
                                                      <div>
                                                            <p class="text-slate-900  font-medium">{{ $item->desa->nama }}</p>
                                                            <p class="text-sm text-slate-500 ">{{ $item->kecamatan->nama }}</p>
                                                      </div>
                                                </td>
                                                <td class="px-6 py-4">
                                          ...
                                          <tr>
                                                <td colspan="7" class="px-6 py-12 text-center">
                                                      <div class="flex flex-col items-center justify-center">
                                                            ...
                                                            <p class="text-slate-600  font-medium">Belum ada mustahik</p>
                                                            <p class="text-slate-500  text-sm mt-1">Mulai tambah data mustahik dengan klik tombol di atas</p>

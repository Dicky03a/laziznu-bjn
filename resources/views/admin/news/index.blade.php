                                    ...
                                    <tbody class="divide-y divide-slate-200 ">
                                          ...
                                          <tr class="hover:bg-slate-50  transition-colors">
                                                <td class="px-6 py-4">
                                                      ...
                                                      <p class="text-sm text-slate-600  mt-1">{{ Str::limit($item->excerpt ?? strip_tags($item->content), 50) }}</p>
                                                </td>
                                                <td class="px-6 py-4">
                                                      @if ($item->category)
                                                ...
                                                <td class="px-6 py-4 text-right">
                                                      <div class="flex items-center justify-end gap-3">
                                                            <a href="{{ route('news.edit', $item) }}" class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-blue-600  hover:bg-blue-50  rounded-lg transition-colors">

...
@section('title', '403 - Akses Ditolak | NU Care LAZISNU Bojonegoro')
...
<div class="flex items-center justify-center min-h-[60vh] px-4 py-16">
      <div class="text-center max-w-xl">
            ...
            <p class="mb-10 text-lg leading-relaxed text-zinc-500 dark:text-zinc-400">
                  Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Jika Anda merasa ini adalah kesalahan, silakan hubungi administrator kami.
            </p>

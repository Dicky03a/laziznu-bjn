...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            'disks' => [
                'local',
                // 's3', // Uncomment to enable S3 backup storage
            ],
        ],
         ...
         * For production, set BACKUP_ARCHIVE_PASSWORD environment variable.
         */
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'dickycoding@gmail.com'),
